<x-layout>
    ...
    <article class="py-8 max-w-screen-md border-b border-gray-300">
        ...
        <div>
            By
            <a href="/authors/{{ $post->author->username }}" class="hover:underline text-base text-gray-500"> {{ $post->author->name }}</a> in <a href="" class="hover:underline text-base text-gray-500">Web Progamming</a> | {{ $post->created_at->diffForHumans() }}
        </div>
